...
## 💡 느낀 점
일단 먼저 제로초님의 유튜브에 4강도 있는지 보았을때 없어서
다른 유튜브에 조금 쉽게 설명해주시는 분이 계셔서 그분것을 보며
1차 정리를 하고, 그뒤에 책에있는 개념들을 추가로 정리를 했습니다.

개념정리를 하면서 그래도 조금씩 더 공부가 되었던것 같습니다.

아직 클론코딩을 하고 있지만 추후에 다른분들처럼 혼자 하게 되는날이되면
실습밑에 부분에 이런기능을 추가해보자! 하고 메모를 해두었습니다.

약간 다른분들에 비해 많이 뒤에 쳐져있는 느낌이라서 최대한 이해하고
빠르게 습득해보려 노력중이지만 일도병행하고 진도도 나가야되고 하다보니 조금 뎌뎌지는거 같은데 최대한 노력해보겠습니다!

다른분들은 매주 스스로 코드를 짜고
저는 매주 클론코딩을 현재 하고있는데 모른다고 아예 안해보는것보다는
따라서 한번씩 하다보면 조금 코드가 눈에 익어가고 자주사용하다보면
안하는것보다는 낫지않을까...해서 다른팀원분들에 비해 부족하지만
느리더라도... 모자란팀원이지만.. 귀찮게 실습따라하면서도 물어보는 경우가 많아질수도 있지만... 잘 이끌어주세요!! 
