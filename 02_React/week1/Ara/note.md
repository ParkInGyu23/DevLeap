...
## 💡 느낀 점 
  ...
  form 부분은 이미 스프린트 미션을 통해서 어느정도 이해가 갔다고 생각했음에도,
  폼을 제어하는 다양한 방법이 있고 다양한 입력값들을 한 번에 제어하기 위해서 사용하는 깔끔한 코드들을 배울 수 있었습니다.
  
  

## 💡 어려운 점
  typescript 속성부터 처음 보는 구조와 단어들로 이해하고 사용하기가 어려웠습니다.
  어떤 부분이 typescript에서만 사용되는 구조이고 문법인지 검색해가며 책을 읽었음에도
